...
class Parameter(ASTNode):
    def __init__(self, name: str, type_: DataType, is_reference: bool = False, array_dimensions: Optional[List[int]] = None):
        self.name = name
        self.type = type_
        self.is_reference = is_reference
        self.array_dimensions = array_dimensions  # For array parameters
